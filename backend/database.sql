...
CREATE TABLE IF NOT EXISTS `serenity`.`administrator` (
...
CREATE TABLE IF NOT EXISTS `serenity`.`form` (
    `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `serenity`.`practician` (
    `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `serenity`.`intervention_patient` (
    `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `serenity`.`theme_ressource` (
    `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `serenity`.`ressource` (
    `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `serenity`.`intervention_ressource` (
    `intervention_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `serenity`.`patient_intervention_ressource` (
    `intervention_patient_id` INT NOT NULL,
    `intervention_ressource_ressource_id` INT NOT NULL,
    `is_done` TINYINT NOT NULL,
    CONSTRAINT `fk_intervention_patient_has_intervention_ressource_descriptio1` FOREIGN KEY (`intervention_ressource_ressource_id`) REFERENCES `serenity`.`intervention_ressource` (`ressource_id`),
...
CREATE TABLE IF NOT EXISTS `serenity`.`ressource_relax` (
    `id` INT NOT NULL AUTO_INCREMENT,
    `title` VARCHAR(255) NOT NULL,
    `url` TEXT NOT NULL,
